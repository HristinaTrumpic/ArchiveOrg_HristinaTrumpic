...
public class AudioIconElements extends Waiters {

	static WebDriver driver;

	public AudioIconElements(WebDriver driver) {
		this.driver = driver;
	}
	...
	private static List<WebElement> featuredCol() {
		return driver.findElements(By.cssSelector(
				"#nav-tophat > div.row.toprow.fivecolumns.audio > div.col-sm-2.col-xs-7.col-sm-push-4 > div a"));
	}
	...
	private static List<WebElement> topCol() {
		return driver.findElements(By.cssSelector(
				"#nav-tophat > div.row.toprow.fivecolumns.audio > div.col-sm-2.col-xs-7.col-sm-push-2 > div a"));
	}
	...
	private static List<WebElement> lastCol() {
		return driver.findElements(
				By.cssSelector("#nav-tophat > div.row.toprow.fivecolumns.audio > div:nth-child(5) > div a"));
	}
