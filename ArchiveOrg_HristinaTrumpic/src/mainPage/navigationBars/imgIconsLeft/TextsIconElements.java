...
public class TextsIconElements extends Waiters {

	static WebDriver driver;

	public TextsIconElements(WebDriver driver) {
		this.driver = driver;
	}
	...
	private static List<WebElement> featuredCol() {
		return driver.findElements(By.cssSelector(
				"#nav-tophat > div.row.toprow.fivecolumns.texts > div.col-sm-2.col-xs-7.col-sm-push-4 > div a"));
	}
	...
	private static List<WebElement> topCol() {
		return driver.findElements(By.cssSelector(
				"#nav-tophat > div.row.toprow.fivecolumns.texts > div.col-sm-2.col-xs-7.col-sm-push-2 > div a"));
	}
	...
	private static List<WebElement> lastCol() {
		return driver.findElements(
				By.cssSelector("#nav-tophat > div.row.toprow.fivecolumns.texts > div:nth-child(5) > div a"));
	}
	...
	public void clickBooksToBorrowLink() {
