...
public class SearchPage extends Waiters {
	...
	private static List<WebElement> resultList() {
		return driver.findElements(By.cssSelector("div.results div:not(.mobile-header).item-ia.hov"));
	}
	...
	// click on buttons to sort the content
		public void clickResultOnList(int i) {
			getResultList().get(i).click();
		}
		
	// checking size of the list
		public int sizeResultOnList() {
